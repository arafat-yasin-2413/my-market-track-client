        ...
        <>
            ...
            <section className="w-10/12 mx-auto">
                <div className="drawer lg:drawer-open">
                    ...
                    />
                    <div className="drawer-content flex flex-col min-h-screen overflow-y-auto">
                        {/* Navbar */}
                            ...
                            <ul>
                                ...
                                {!isPending && role === "user" && (
                                    <>
                                        <DashboardMenu
                                            ...
                                            link={"/dashboard/viewPriceTrends"}
                                            Icon={GrLineChart}
                                        ></DashboardMenu>
                                        <DashboardMenu
                                            title={"Manage Watchlist"}
                                            link={"/dashboard/myWatchlist"}
                                            Icon={FaHeart}
                                        ></DashboardMenu>
                                        <DashboardMenu
                                            title={"My Order List"}
                                            link={"/dashboard/myOrderList"}
                                            Icon={FaListAlt}
                                        ></DashboardMenu>
                                        <DashboardMenu
                                ...
                                {!isPending && role === "vendor" && (
                                    <>
                                        ...
                                        <DashboardMenu
                                            ...
                                            link="/dashboard/addAdvertisement"
                                            Icon={FaBullhorn}
                                        ></DashboardMenu>
                                        <DashboardMenu
                                            title={"My Advertisements"}
                                            link="/dashboard/myAdvertisements"
                                            Icon={FaFolderOpen}
                                        ></DashboardMenu>
                                    </>
                                )}
                                ...
                                {!isPending && role === "admin" && (
                                    <>
                                        ...
                                        <DashboardMenu
                                            title={"All Product"}
                                            link="/dashboard/allProductAdmin"
                                            Icon={FaBoxOpen}
                                        ></DashboardMenu>
                                        <DashboardMenu
                                            title={"All Advertisement"}
                                            link="/dashboard/allAdvertisement"
                                            Icon={MdCampaign}
                                        ></DashboardMenu>
                                        <DashboardMenu
                                            title={"All Order"}
                                            link="/dashboard/allOrder"
